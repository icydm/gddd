...
if(! defined('FILE_CACHE_PREFIX') )             define ('FILE_CACHE_PREFIX', 'gddd');                               // What to put at the beg of all files in the cache directory so we can identify them
...
if(! isset($ALLOWED_SITES)){
  require( '../../../../../../wp-load.php' );
  $gd_link_white = of_get_option('timthumbwhite','');
  $ALLOWED_SITES = explode(',', $gd_link_white );
}
// -------------------------------------------------------------
        ...
        public function __construct(){
                ...
                if(FILE_CACHE_DIRECTORY){
                        ...
                        if (!touch($this->cacheDirectory . '/index.html')) {
                                $this->error("Need to cache folder permissions set to more than 755 (or 777)");
                        }
                } else {
                ...
                if($this->isURL){
                        if(ALLOW_ALL_EXTERNAL_SITES){
                                ...
                                if(! $allowed){
                                        return $this->error("Need to add the picture outside the chain domain name!");
                                }
                        }
                }
